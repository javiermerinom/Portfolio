...
export const experiences = [
  {
    ...
    desc: "Worked on a data warehouse project for a chimistry lab analyzing chemical compounds from hops used in brewing. Assisted in data collection, transformation, and automation processes.",
    skills: [
      "Python",
      "Github",
      "Automation",
  ...
  },
  {
    id: 1,
    img: cntlogo,
    role: "Senior Buniness Analyst and Analytics Engineer",
    company: "CNT, Telecommunications Service Provider - Quito, Ecuador",
    date: "July 2019 - February 2024",
    desc: "Implemented a data-driven initiative to optimize international voice operations, overseeing contract management, provider relations, revenue assurance, and budget performance.",
    skills: [
      "Data Analysis",
      "Power BI",
      "Excel",
  ...
  },
  {
    id: 2,
    img: cntlogo,
    role: "Senior Buniness Analyst and Procurement Specialist",
    company: "CNT, Telecommunications Service Provider - Quito, Ecuador",
    date: "February 2018 - June 2019",
    desc: "Spearheaded data analysis to guide decision-making for large-scale network capacity acquisitions, overseeing RFI/RFP evaluation, contract negotiation, and execution processes.",
    skills: [
      "Data Analysis",
      "Power BI",
      "Excel",
  ...
  },
  {
    id: 5,
    img: arcotellogo,
    role: "Technical and Regulation Analyst",
    company: "ARCOTEL, Telecomunications Regulatory Authority - Quito, Ecuador",
    date: "April 2011 - July 2013",
    desc: "Drove Ecuador's broadcasting modernization through the digital TV transition, regulatory alignment, and nationwide presentations promoting adoption of new standards.",
    skills: [
